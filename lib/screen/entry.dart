...
class _EntryState extends State<Entry> {
  ...
  MaterialAccentColor mansColor = null; // 男のボタンの色
  MaterialAccentColor womansColor = null; // 女のボタンの色
  ...
  /* 性別ボタンを押すと、ボタンの文字色が変化 */
  Color _choiceColor(int buttonGender) {
    if (gender == buttonGender) return Colors.white;
    return Colors.black;
  }
  ...
  * gender = 0: man, 1: woman */
  void _genderUpdate(int newGender) {
    setState(() {
      gender = newGender;
      if (gender == 0) {
        mansColor = Colors.blueAccent;
        womansColor = null;
      } else {
        mansColor = null;
        womansColor = Colors.redAccent;
      }
    });
  }
